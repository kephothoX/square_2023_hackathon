...
export class AppService {
  ...
  FirebaseFunctionsEndpoint = 'https://us-central1-healus-a85f5.cloudfunctions.net';


  getAuthorizationToken(): Observable<any> {
    const data = {};
    return this._httpClient.post(`${ this.FirebaseFunctionsEndpoint }/token`, data).pipe(catchError(this._errorService.handleError));
  }

  listMerchants(): Observable<any> {

    return this._httpClient.get(`${ this.FirebaseFunctionsEndpoint }/getSquareMerchants`).pipe(catchError(this._errorService.handleError));
  }
